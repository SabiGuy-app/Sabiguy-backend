...
walletSchema.methods.creditBonus = async function (amount) {
  if (typeof amount !== "number" || isNaN(amount)) {
    throw new Error("Invalid amount for bonus credit");
  }
  this.balance.bonus += amount;
  this.balance.total += amount;
  this.lastTransactionAt = new Date();
...
walletSchema.methods.debitBonus = async function (amount) {
  if (typeof amount !== "number" || isNaN(amount)) {
    throw new Error("Invalid amount for bonus debit");
  }
  if (this.balance.bonus < amount) {
